(function ($, undefined) {
    ...
    $.indyMasonry.defaults = {
        'clName': '.indy-masonry',  //默认的排列的元素类名
        'gap': 0,                   //模块排列的间距
        'mPadding_left': 4,
        'mPadding_right': 4,
        'mTop': 0,
    ...
    $.indyMasonry.prototype = {
        ...
        _masonryCallback: function (options) {
            ...
            _self.mPadding_left = _self.options.mPadding_left;
            _self.mPadding_right = _self.options.mPadding_right;
        ...
        _elementPosition: function (elSet) {
            ...
            elSet.each(function (index) {
                ...
                element.css({
                    ...
                    'padding-left': _self.mPadding_left + 'px',
                    'padding-right': _self.mPadding_right + 'px',
                });
                countDelta = 0;
